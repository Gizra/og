...
- Visit the admin/og/og page. If you want to protect posts within private groups, click the button to enable access control.
...
- On the admin/content/types/og page, disable commenting and attachments for node types which are designated as groups
