...
class OgAccessEntityTestBase extends OgAccessTestBase {
  ...
  public function setup() {
    ...
    // Some mocked groups that are referenced by the content entity.
    $groups = [
      $this->prophesize(ContentEntityInterface::class),
      $this->prophesize(ContentEntityInterface::class),
    ];

    $og_audience = $this->prophesize(EntityReferenceFieldItemList::class);
    $og_audience->referencedEntities()->willReturn($groups);
