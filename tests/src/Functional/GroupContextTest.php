 ...
 * @group og
 */
class GroupContextTest extends BrowserTestBase {
  ...
  public function setUpEntityTestEntity() {
    ...
    Og::groupResolverHandler()->updatePlugin('entity', ['status' => TRUE]);
  }

  function testGroupContext() {
    $this->drupalLogin($this->groupEditor);
    $this->drupalGet($this->contentGroup->toUrl('edit-form'));
    $this->assertNotEmpty(Og::groupResolverHandler()->getGroup());
  }
